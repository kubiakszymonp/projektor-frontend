...
export const TextUnitEditDialog: React.FC<{
  ...
  const [currentTextUnit, setCurrentTextUnit] =
    useState<CurrentTextUnitType>(emptyTextUnitObject);
  ...
  const loadTextUnit = async () => {
    if (textUnitId === null) {
      ...
      const res = await textUnitApi.textUnitControllerFindOne(
        String(textUnitId)
      );
  ...
  return (
    <Dialog fullWidth open={open} onClose={handleClose}>
      <DialogTitle>
        {textUnitId === null ? "Dodaj nowy tekst" : "Edytuj tekst"}
      </DialogTitle>
      <DialogContent>
        <TextField
          required
